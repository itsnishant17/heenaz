...
const bentoItems = [
  ...
  { src: bridalFull,        alt: 'Bridal full look black gold',  label: 'Competition Look',  span: [1, 1], pos: 'top center', hideOnDesktop: true },
  { src: workLip2,          alt: 'Final lip touch-up',           label: 'Final Touches',     span: [1, 1], pos: 'top center', hideOnDesktop: true, hideOnMobile: true },
];
      ...
      <FadeIn>
        <div className="gallery__bento">
          {bentoItems.map((item, i) => {
            const classes = ['gallery__cell'];
            if (item.hideOnDesktop) classes.push('gallery__cell--hide-desktop');
            if (item.hideOnMobile) classes.push('gallery__cell--hide-mobile');
